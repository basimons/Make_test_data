...
addpath(genpath('C:\Users\Bram\Documents\TU\Master\MEP\Programs\Kilosort3')) % path to kilosort folder
...
run(fullfile(pathToYourConfigFile, 'StandardConfig_KS3.m'))
...
ops.fshigh     = 5; % high-pass more aggresively
